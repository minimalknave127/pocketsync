  ...
  "group flex flex-row items-center justify-center rounded-xl web:ring-offset-background web:transition-colors web:focus-visible:outline-none web:focus-visible:ring-2 web:focus-visible:ring-ring web:focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructiveGhost:
          "web:hover:bg-destructive web:hover:text-destructive-foreground active:bg-destructive bg-destructive/10",
        outline:
      ...
      size: {
        default: "!h-14 px-4 py-2 native:h-12 native:px-5 native:py-3",
        sm: "h-9 rounded-md px-3",
        lg: "!h-16 rounded-xl px-8 native:h-14",
        icon: "h-10 w-10",
      },
    },
